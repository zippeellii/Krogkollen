 ...
 * 
 * @author Johan Backman Date: 2013-09-22
 */
class MarkerOptionsFactory {
	 ...
	 */
	public static MarkerOptions createMarkerOptions(Resources resources, int resourceId,
			String mainText,
		...
		canvas.drawText((denotedText), 7 + (minWidthHeight / marginRatio),
				62 + (minWidthHeight / marginRatio), paint);
