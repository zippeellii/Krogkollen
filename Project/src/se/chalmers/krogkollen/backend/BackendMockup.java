...
public class BackendMockup implements IBackend {
	 ...
	 * 
	 * @param exceptions if 1: always throw NoBackendAccessException, if 2: always throw NotFoundInBackendException
	 */
	...
	@Override
	public void addRatingVote(IPub pub, int rating)
	...
	@Override
	public void removeRatingVote(IPub pub, int rating)
			throws NoBackendAccessException, NotFoundInBackendException {
		this.throwNoBackend();
		this.throwNotFound();
