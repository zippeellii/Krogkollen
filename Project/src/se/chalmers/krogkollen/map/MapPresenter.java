			...
			handler.post(new Runnable() {
				...
				public void run() {
					try {
							...
							for (IPub newPub : PubUtilities.getInstance().getPubList()) {
								...
								if (oldPub.getID().equals(newPub.getID())) {
									...
									if (oldPub.getQueueTime() != newPub.getQueueTime()
											...
											||
											!oldPub.getTodaysOpeningHours()
													.toString()
													.equals(newPub.getTodaysOpeningHours()
															.toString()) ||
						...
						mapView.showErrorMessage(resources
								.getString(R.string.error_no_backend_access));
					} catch (NotFoundInBackendException e) {
						mapView.showErrorMessage(resources
								.getString(R.string.error_no_backend_item));
